        ...
        <div class="form-horizontal__item">
            ...
            <div>
                ...
                <?php else: ?>
                    ...
                    <a target="_blank" href="<?php echo $this->getUpgradeMenuItemUrl();?>">(<?php _e('upgrade to pro', CHT_OPT);?>)</a>
                <?php endif; ?>
      ...
      function limitLines(obj, e) {
        ...
        <div class="form-horizontal__item widget-icon__block">
            ...
            <label class="widget-icon__wrap">
                ...
                <?php if(!$this->is_pro()): ?>
                    <a target="_blank" class="custom-control custom-radio " href="<?php echo $this->getUpgradeMenuItemUrl();?>" >
                <?php else:?>
...
<style type="text/css">.st1{fill:#FFFFFF;}</style>
	...
	c0.2,0,0.2,0,0.3,0c0.3-0.2,0.5-0.5,0.5-0.9v-18C-455.9,524.1-457.5,522.5-459.4,522.5z"/>
                ...
                <?php endif;?>
            <?php if(!$this->is_pro()): ?>
                <a target="_blank" class="upgrade-link" href="<?php echo $this->getUpgradeMenuItemUrl();?>">(<?php _e('upgrade to pro', CHT_OPT);?>)</a>
            <?php endif;?>
