                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th class="product" style="background:#69C7F1; border-top-left-radius: 5px; border-left:0px;">
                                ...
                                <img src="<?php echo SCCP_ADMIN_URL . '/images/avatars/personal_avatar.png'; ?>" alt="Free" title="Free" width="100"/>
                            </th>
                            <th class="product" style="background:#69C7F1;">
                                <span style="display: block"><?php echo  __('Business',$this->plugin_name)?></span>
                                <img src="<?php echo SCCP_ADMIN_URL . '/images/avatars/business_avatar.png'; ?>" alt="Business" title="Business" width="100"/>
                            </th>
                            <th class="product" style="border-top-right-radius: 5px; border-right:0px; background:#69C7F1;">
                                ...
                                <img src="<?php echo SCCP_ADMIN_URL . '/images/avatars/pro_avatar.png'; ?>" alt="Developer" title="Developer" width="100"/>
                            </th>
                        </tr>
                        <tr>
                            <th></th>
                        ...
                        <tr>
                            <td></td>
                            <td colspan="4"><?php echo __('Country blocker',$this->plugin_name)?></td>
                        </tr>
                        <tr>
                            <td><?php echo __('Country blocker',$this->plugin_name)?></td>
                            <td><span>–</span></td>
                            <td><i class="ays_fa ays_fa_check"></i></td>
                            <td><i class="ays_fa ays_fa_check"></i></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td colspan="4"><?php echo __('IP blocker',$this->plugin_name)?></td>
                        </tr>
                        <tr>
                            <td><?php echo __('IP blocker',$this->plugin_name)?></td>
                            <td><span>–</span></td>
                            <td><i class="ays_fa ays_fa_check"></i></td>
                            <td><i class="ays_fa ays_fa_check"></i></td>
                        </tr>
                        ...
                        <tr>
                            <td></td>
                            <td colspan="4"><?php echo __('Block content with password',$this->plugin_name)?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td><a href="https://wordpress.org/plugins/secure-copy-content-protection/" class="price-buy"><?php echo __('Download',$this->plugin_name)?><span class="hide-mobile"></span></a></td>
                            <td><a href="https://ays-pro.com/index.php/wordpress/secure-copy-content-protection" class="price-buy"><?php echo __('Buy now',$this->plugin_name)?><span class="hide-mobile"></span></a></td>
                            <td><a href="https://ays-pro.com/index.php/wordpress/secure-copy-content-protection" class="price-buy"><?php echo __('Buy now',$this->plugin_name)?><span class="hide-mobile"></span></a></td>
                        </tr>
                        </tbody>
                    </table>
