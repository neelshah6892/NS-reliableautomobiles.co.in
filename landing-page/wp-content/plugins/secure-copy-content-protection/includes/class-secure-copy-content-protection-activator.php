		...
		if ($count == 0) {
			$wpdb->insert(
				...
				array(
					...
					'options'           => '{"developer_tools":"checked","context_menu":"checked","drag_start":"checked","ctrlc":"checked","ctrlv":"checked","ctrls":"checked","ctrla":"checked","ctrlx":"checked","ctrlu":"checked","ctrlf":"checked","f12":"checked","enable_text_selecting":""}',
					'audio'             => ''
				),
				array('%s', '%s', '%d', '%s', '%s', '%s')
			);
